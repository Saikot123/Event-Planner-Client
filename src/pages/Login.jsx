                    ...
                    <div className="card-body text-secondary">
                        ...
                        <form onSubmit={handleLogin}>
                            <fieldset className="fieldset">
                                ...
                                <div className='text-base mb-4'>Create an Account? <a className="link link-hover font-semibold"><Link to={'/register'}>Register</Link></a></div>

                                {/* Google */}
                                <button  type='button' onClick={handleGoogle} className="btn w-full border border-secondary bg-white !text-black dark:bg-primary dark:!text-white">
